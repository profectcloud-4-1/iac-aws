...
resource "aws_apigatewayv2_route" "user" {
  ...
  authorizer_id      = aws_apigatewayv2_authorizer.common_lambda[aws_apigatewayv2_api.user.id].id
  target             = "integrations/${aws_apigatewayv2_integration.user_1.id}"
}
...
resource "aws_apigatewayv2_route" "product" {
  ...
  authorization_type = "CUSTOM"
  authorizer_id      = aws_apigatewayv2_authorizer.common_lambda[aws_apigatewayv2_api.product.id].id
...
resource "aws_apigatewayv2_route" "order" {
  ...
  authorization_type = "CUSTOM"
  authorizer_id      = aws_apigatewayv2_authorizer.common_lambda[aws_apigatewayv2_api.order.id].id
...
resource "aws_apigatewayv2_route" "payment" {
  ...
  authorization_type = "CUSTOM"
  authorizer_id      = aws_apigatewayv2_authorizer.common_lambda[aws_apigatewayv2_api.payment.id].id
